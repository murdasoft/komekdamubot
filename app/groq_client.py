...
def get_system_prompt(lang: str = "ru", city: str | None = None) -> str:
    ...
    if lang == "kk":
        examples = (
            ...
            "— Чёрный список: 'Чёрного списка нет. Есть плохая кредитная история. Если плохая история — приходите на бесплатную консультацию, сделаем анализ когда одобрят кредит.\\n{office} [DONE]'\n"
