...
def get_system_prompt(lang: str = "ru", city: str | None = None) -> str:
    ...
    if lang == "kk":
        examples = (
            ...
            "— ИП залог: 'ИП-ге кепілдік несие 500 млн-ға дейін, 12,6%, 10 жылға. Без кепілдік ИП-ге DAMU жоқ. Келіңіз.\\n{office} [DONE]'\n"
            ...
            "— ИП залог: 500 млн, 12,6%, 10 жыл (без кепілдік DAMU жоқ)\n"
        ...
        examples = (
            ...
            "— ИП залог: 'Залоговый кредит для ИП до 500 млн, 12,6%, до 10 лет. Беззалоговый DAMU для ИП нет. Приходите.\\n{office} [DONE]'\n"
            ...
            "— ИП залоговый: до 500 млн, 12,6%, до 10 лет (беззалоговый нет)\n"
