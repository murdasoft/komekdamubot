...
def get_system_prompt(lang: str = "ru", city: str | None = None) -> str:
    ...
    return (
        ...
        f"— ИП без залога (рус): 'Найдём для вас выгодные условия под низкий процент. До 35 млн, срок до 3 лет. Приглашаем в офис.\n{office_block} [DONE]'\n"
        f"— ИП без залога (каз): 'Сізге тиімді шарттармен несие табамыз. 35 млн-ға дейін, 3 жылға. Келіңіз.\n{office_block} [DONE]'\n"
