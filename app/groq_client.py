...
def get_system_prompt(lang: str = "ru") -> str:
    ...
    return (
        ...
        "— Кредит (ru): 'Кредит оформим. Ставка от 18%, до 10 млн. Приходите в офис — деньги вперёд не берём. Адрес: [адрес]. [DONE]'\n"
        "— Несие (kk): 'Несие рәсімдейміз. Ставка 18%-дан, 10 млн-ға дейін. Офисімізге келіңіз — алдын ала ақша алмаймыз. Мекенжай: [мекенжай]. [DONE]'\n"
        ...
        "— Кредит физлицу: от 18%, до 10 млн, до 5 лет, без открытых просрочек\n"
