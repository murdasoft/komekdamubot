...
def get_system_prompt(lang: str = "ru") -> str:
    return (
        ...
        "КРИТИЧЕСКИ ВАЖНО: Отвечайте на ТУЖЕ ЯЗЫКЕ, на котором написал пользователь. "
        "Если вопрос на казахском — отвечайте ТОЛЬКО на казахском. "
        "Если вопрос на русском — отвечайте ТОЛЬКО на русском. "
        "Не смешивайте языки. Общайтесь вежливо, чётко и по существу. "
        "НОВЫЕ ТРЕБОВАНИЯ:\n"
