...
FAQ_PATTERNS: list[_Pattern] = [
    ...
    _Pattern(("жұмыс уақыты", "график", "сағат", "нешеғе дейін", "во сколько", "режим", "сағат"), faq_key="work_hours", weight=3),
    _Pattern(("тарих", "история", "кредитная история", "қарайсыз", "қараймыз"), faq_key="credit_history", weight=3),
    _Pattern(("гарантия", "бересіздер", "көмек", "алу", "мағандар"), faq_key="guarantee_info", weight=3),
    _Pattern(("процент", "ставка", "неше", "қанша", "пайыз"), faq_key="interest_rate", weight=3),
    _Pattern(("условия", "шарт", "тәртіп", "керек", "какие условия"), faq_key="conditions_info", weight=3),
    _Pattern(
...
EXTRA_FAQ = {
    ...
    "operator_hint": {
        "ru": "Чтобы связаться с менеджером, напишите «оператор» или нажмите кнопку «Менеджер».",
    ...
    "credit_howto": {
        "ru": "Чтобы узнать шансы — выберите раздел (1–7) или напишите сумму и цель.",
        "kk": "Мүмкіндігін білу үшін бөлімді таңдаңыз (1–7) немесе сома мен мақсатыңызды жазыңыз.",
    },
    "credit_history": {
    ...
    "guarantee_info": {
        "ru": "Гарантии нет — каждый случай рассматривается индивидуально. Приходите в офис — подберём вариант.",
        "kk": "Кепілдік жоқ — әр жағдай жеке қаралады. Офиске келіңіз — нұсқа таңдаймыз.",
    },
    "interest_rate": {
        "ru": "Ставки зависят от продукта: ИП — от 21%, ипотека — 2–22%, DAMU — 12,6%. Точный расчёт в офисе.",
        "kk": "Пайыз өнімге байланысты: ИП — 21%-дан, ипотека — 2–22%, DAMU — 12,6%. Нақты есеп офисте.",
    },
    "conditions_info": {
        "ru": "Условия зависят от продукта и вашей ситуации. Без открытых просрочек — главное. Консультация бесплатная.",
        "kk": "Шарттар өнім мен жағдайыңызға байланысты. Ашық кешігу болмауы керек. Кеңес тегін.",
    },
}
