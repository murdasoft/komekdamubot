...
FAQ_PATTERNS: list[_Pattern] = [
    ...
    _Pattern(("пенсионк", "пенсия", "зейнеткер", "зейнет"), faq_key="pension_info", weight=3),
    _Pattern(("нагрузк", "жүктеме", "қаржыл"), faq_key="credit_load", weight=3),
    _Pattern(("скорбал", "скоринг", "балл"), faq_key="scoring_info", weight=3),
    _Pattern(("кредит ала", "берес", "қайда", "кредит бер"), faq_key="credit_howto", weight=3),
    _Pattern(
